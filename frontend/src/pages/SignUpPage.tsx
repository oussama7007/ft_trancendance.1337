...
const LinkedinIcon = () => (
  ...
  >
    <path
      d="M5 3a2 2 0 1 0 0 4 2 2 0 0 0 0-4zM3 8h4v12H3V8zm6 0h4v2
      c.56-1.04 1.86-2.5 4.5-2.5
      4 0 4.5 2.63 4.5 6v6h-4v-5.3
      c0-1.26-.02-2.88-1.75-2.88
      -1.75 0-2.02 1.37-2.79V20H9V8z"
    />
  </svg>
);
